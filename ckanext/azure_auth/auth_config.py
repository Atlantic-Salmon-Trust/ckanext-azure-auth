...
ATTR_LOGIN_HELP_TEXT = f'{_EXTNAME}.login_help_text'
ATTR_LOGIN_HELP = f'{_EXTNAME}.login_help'

RENDERABLE_ATTRS = (ATTR_LOGIN_LABEL, ATTR_LOGIN_BUTTON, ATTR_LOGIN_HELP_TEXT, ATTR_LOGIN_HELP)
